...
def register_endpoint(payload: UserCreate, db: DbSession):
    try:
...
def login_endpoint(payload: UserLogin, db: DbSession):
    try:
...
def refresh_endpoint(payload: RefreshRequest, db: DbSession):
    try:
